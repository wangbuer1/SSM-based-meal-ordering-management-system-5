...
<div class="crumb-wrap">
    <div class="crumb-list"><i class="icon-font"></i>首页<span class="crumb-step">&gt;</span><span class="crumb-name">种类管理</span></div>
</div>
    ...
    <form name="myform" id="myform" method="post">
        <div class="result-title">
            <div class="result-list">
       			<i class="icon-font"></i>欢迎来到种类管理界面
            </div>
        </div>
...
$(function(){
	...
	$(".link-update").on("click",function(){
		...
		$(".right").load("kindUpdate.action",{id:id});
	});
})
//deleteKind.action?id=${c.id}
$(function(){
	var url = "kindDelete.action";
	var cc = $(".baseUI li:contains('种类管理')");
...
$(function(){
	...
	$(".link-page").on("click",function(){
		var id = $(this).attr("val");
		$(".right").load("kindManager.action",{id:id});
	});
})
</script>