...
<div class="login" style="margin-top:50px;">
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="registerSuccess.action" method="post">
