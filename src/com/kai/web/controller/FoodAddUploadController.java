...
@Controller
public class FoodAddUploadController {

    /**
     * 图片文件上传
     */
    @RequestMapping(value = "/foodAddUpload.action", method = RequestMethod.POST)
        ...
        if (file != null) {// 判断上传的文件是否为空
            ...
            if (type != null) {// 判断文件类型是否为空
                if ("GIF".equals(type.toUpperCase()) || "PNG".equals(type.toUpperCase()) || "JPG".equals(type.toUpperCase())) {
                    ...
                    String path1 = protectionDomain.getCodeSource().getLocation().getPath();
                    System.out.println("测试=" + path1);
                    String str = path1.substring(0, path1.indexOf("out"));
                    String realPath = str + "WebContent/photo/";
...
//                    String realPath = "E:\\Mars_Eclipse\\workspace\\GoodStomach\\WebContent\\photo\\";
        ...
        Food food = new Food(null, name, price, url, burdenMessage, foodMessage, k_id);
        FoodService foodService = new FoodService();
        foodService.addOne(food);
